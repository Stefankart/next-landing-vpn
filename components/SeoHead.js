...
const defaultMeta = {
  ...
  siteName: 'Legal-Ally',
  description:
    'Landing page VPN Legal-Ally Best VPN For Privacy, Country and Cheapest',
...
const SeoHead = (props) => {
  ...
  return (
    <Head>
      ...
      {/* Windows 8 app icon */}
      <meta name='msapplication-TileColor' content='#1A336F' />
      <meta
        name='msapplication-TileImage'
        content='/favicon/ms-icon-144x144.png'
      />
      {/* Accent color on supported browser */}
      <meta name='theme-color' content='#1A336F' />
    </Head>
  );
};
